...
date modified: 2022-05-12 13:05:12
---
...
![](assets/%E8%B7%AF%E5%BE%84%E8%B7%9F%E8%B8%AA/2022-05-12-12-38-02.png)
![](assets/%E8%B7%AF%E5%BE%84%E8%B7%9F%E8%B8%AA/2022-05-12-12-38-15.png)
![](assets/%E8%B7%AF%E5%BE%84%E8%B7%9F%E8%B8%AA/2022-05-12-12-38-22.png)
...
![](assets/路径跟踪/624d2c36239250f7c54bbb85.png)

open | clamped | closed
---|---|---
![](assets/路径跟踪/624d2bab239250f7c54ab754.png)|![](assets/路径跟踪/624d2c08239250f7c54b66ce.png)|![](assets/路径跟踪/624d2c0f239250f7c54b746f.png)
![](assets/路径跟踪/624d3904239250f7c565e33c.png)
...
- [Interpolation (scipy.interpolate) — SciPy v1.8.0 Manual](https://docs.scipy.org/doc/scipy/reference/interpolate.html?highlight=spline#id1)
    - ![](assets/路径跟踪/624d6cca239250f7c5d1005d.png)
...
!!! example "2-D B-Spline"
    ...
    ![](assets/路径跟踪/624d73ae239250f7c5df48ea.png)
...
!!! example
    ...
    ![](assets/路径跟踪/624d3f73239250f7c572c961.png)
    基函数
    ![](assets/路径跟踪/624d4071239250f7c574dda3.png)
    主函数：
    ![](assets/路径跟踪/624d470a239250f7c5821f84.png)
...
> 简单乘系数效果很差.
> [激活函数--（Sigmoid，tanh，Relu，maxout） - weilongyitian - 博客园](https://www.cnblogs.com/missidiot/p/9378079.html)
> 用过 `tanh`, 可能是因为激活函数的斜率变化太大, 船会升到很快的速度又来不及减速.
> 所以还是对数好用很多.
...
![](assets/路径跟踪/624ad591239250f7c5815b0b.png)
...
??? example "未修正效果"
    ![](assets/路径跟踪/6252b4b0239250f7c5e78489.png)
...
![](assets/路径跟踪/625aa580239250f7c5008c85.png)

![](assets/路径跟踪/625aacd8239250f7c50d5fb7.png)

###### 2.1.3.2.1 方法一: 角度限定范围

1. 首先需要调整 无人艇 模型.
    ![](assets/路径跟踪/6252bdb8239250f7c5f96df5.png)
...
??? example "修正后效果"
    ![](assets/路径跟踪/6252c97c239250f7c515b7f2.png)
    ![](assets/路径跟踪/6252c9fa239250f7c5176c3a.png)
    最后跟踪效果挺好的, 中间过程有点丑陋…
